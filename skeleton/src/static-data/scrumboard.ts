...
import { ScrumboardAttachment } from 'src/app/pages/dashboards/scrumboard/interfaces/scrumboard-attachment.interface';
import { ScrumboardComment } from 'src/app/pages/dashboards/scrumboard/interfaces/scrumboard-comment.interface';
import { ScrumboardLabel } from 'src/app/pages/dashboards/scrumboard/interfaces/scrumboard-label.interface';
import { ScrumboardUser } from 'src/app/pages/dashboards/scrumboard/interfaces/scrumboard-user.interface';
import { Scrumboard } from 'src/app/pages/dashboards/scrumboard/interfaces/scrumboard.interface';
        ...
        children: [
          {
            ...
            users: [scrumboardUsers[0], scrumboardUsers[1]],
          ...
          },
          {
            ...
            description:
              'This widget has superpowers and can display all the great things you love and want in life.',
